                ...
                if (accoutController)
                {
                    ...
                    switch (tab)
                    {
                        case 0:
                            ...
                            {
                                Application.OpenURL("https://www.newline.games/docs/simple-account.html#configuration");
                            }
                        ...
                        case 1:
                            ...
                            if (GUILayout.Button("Help", GUILayout.Width(50)))
                            {
                                Application.OpenURL("https://www.newline.games/docs/simple-account.html#imp-connection");
                            }
                            GUILayout.EndHorizontal();
                            break;
                        case 2:
                            ...
                            if (GUILayout.Button("Help", GUILayout.Width(50)))
                            {
                                Application.OpenURL("https://www.newline.games/docs/simple-account.html#imp-user-stats");
                            }
                            GUILayout.EndHorizontal();
                            break;
                        case 3:
                        ...
                        case 5:
                            ...
                            {
                                Help.BrowseURL("https://www.newline.games/#pricing");
                            }
                            break;
                        case 6:
                            EditorGUILayout.Space();
        ...
        void DataTab()
        {
            ...
            if (GUILayout.Button("Apply"))
            {
                if (SecureDataTransfer)
                {
                    ...
                    switch(option){
                        case 0:
                            Application.OpenURL("https://www.newline.games/#pricing");
                            break;
